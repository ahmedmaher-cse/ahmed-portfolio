  ...
  <main>
    ...
    <section id="home" className="hero">
      <div className="hero-content">
        ...
        <p className="hero-description">
          ...
          exploring hardware design and digital verification.
        </p>
    ...
    <section id="about" className="section">
      ...
      <div className="about-content">
        ...
        <p>
          I'm also currently exploring hardware design and digital
          verification, building on my Digital Logic Design background and
          beginning my journey with Verilog.
        </p>
    ...
    <section id="focus" className="section">
      ...
      <div className="services-grid">
        ...
        <div className="service-card">
          ...
          <p>
            Currently exploring hardware design and digital verification,
            building on my Digital Logic Design background and beginning my
            journey with Verilog.
          </p>
        </div>
      </div>
    </section>
